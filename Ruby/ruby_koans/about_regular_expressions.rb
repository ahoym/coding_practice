...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # -- Never. It always accepts a string whether it is empty or not.
  end
  ...
  def test_slash_z_anchors_to_the_end_of_the_string
    ...
    assert_equal nil, "s0tart end"[/start\z/]
  end
  ...
  #  
  # -- character class has more readability due to less vertical pipes. A 
  #    benchmark from http://stackoverflow.com/questions/4724588/using-alternation-or-character-class-for-single-character-matching
  #    shows that alteration is faster however. Others say the performance
  #    difference is minimal. In conclusion, might be better to use
  #    character class for better readability and shorness.
