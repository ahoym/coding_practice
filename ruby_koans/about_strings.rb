...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # 
    # -- Using the << alters the original string instead of creating a new
    #    one. This can seen by calling the object_id of strings using the 
    #    shovel vs. += operator. This is because += is shorthand for
    #    a = a + b, and << is an alias for concat()
